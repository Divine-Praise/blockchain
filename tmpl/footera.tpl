         ...
         <div class="row">
             <div class="col-12 d-flex align-items-center pb-5">
                 <div class="d-flex align-items-center pb-5 flex-fill" style="border-bottom:1px solid #2D2F3A;">
                     <h3 style="color:#fff;flex:1;" class="pr-5 m-0">{$settings.site_name}: Level 29, one canada square London E14 5AB, united Kingdom.</h3>
             ...
             <div class="col-6 col-md-3 mt-4 mt-md-0">
                 ...
                 <ul class="footer-list">
                     ...
                     <li><a href="mailto:{$settings.support_email}" class="mailto">contact@assetpinnacle.com</a></li>
