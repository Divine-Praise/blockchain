                    ...
                    <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                        <div class="wbox">
                            ...
                            <div class="depboxHome flex-fill d-flex flex-column">
                                ...
                                {if $fatal eq 'withdraw_forbidden'}
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        <i class="fas fa-times-circle mb-3 mt-2"></i>
                                        <h6 class="m-0">Transaction status</h6>
                                ...
                                {if $fatal eq 'too_early_withdraw'}
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        <i class="fas fa-times-circle mb-3 mt-2"></i>
                                        <h6 class="m-0">Transaction status</h6>
                                        ...
                                        <div class="row depResult mt-2">
                                            ...
                                            <div class="bor col-12">
                                                ...
                                                <div class="resultNum d-flex align-items-center p-2">
                                                    <p>Withdrawal from:</p>
                                                    <p>&nbsp;&nbsp;{$currency_sign}{$deposit.deposit} deposit from the <b>{$type.name|escape:html}</b></p>
                                                </div>
                                                ...
                                                <div class="resultNum d-flex align-items-center p-2">
                                                    <p>Our fee is ({$type.withdraw_principal_percent}%): </p>
                                                    <p>&nbsp;&nbsp;that is <b>{$currency_sign}{$fee}.</p>
                                                </div>
                                                <div class="resultNum d-flex align-items-center p-2">
                                                    <p>Actually you will acquire the total of : </p>
                                                    <p>&nbsp;&nbsp;{$currency_sign}{$to_balance} on your balance.</p>
                                                </div>
                            ...
                            <form method=post name=withdraw_form id="withdraw_form">
                                ...
                                <div class="p-3 d-flex flex-column justify-content-center flex-fill">
                                    ...
                                    <div class="depInput d-flex align-items-center m-1 mb-4" style="flex-flow:row wrap">
                                        ...
                                        <input type=text name=amount value="{$deposit.deposit}" id="inputsmoney" autocomplete="off" required="" style="min-width:100px;flex:1;border:0;margin:0;" onchange="withdraw()" onkeyup="withdraw()" onfocusout="withdraw()" onactivate="withdraw()" ondeactivate="withdraw()">
                                ...
                                <path d="M243,0C108.8,0,0,108.8,0,243s108.8,243,243,243s243-108.8,243-243S377.2,0,243,0z M312.8,338.8 c-10.6,12.9-24.4,21.6-40.5,26c-7,1.9-10.2,5.6-9.8,12.9c0.3,7.2,0,14.3-0.1,21.5c0,6.4-3.3,9.8-9.6,10
                                    ...
                                    <div class="row depResult mt-2">
                                        ...
                                        <div class="bor col-12">
                                            ...
                                            <div class="resultNum d-flex align-items-center p-2" style="border-radius:0 0 0 0;border-top:0px solid #fff;">
                                                <p>Withdraw fee ({$type.withdraw_principal_percent}%) :</p>
                                                <p>&nbsp;&nbsp;{$currency_sign}0.01 as minimal</p>
                                            </div>
                                            <div class="resultNum d-flex align-items-center p-2">
                                                <p>You will get on you account balance : </p>
                                                <p>&nbsp;&nbsp;{$currency_sign}<span id="quote" name=quote readonly style="color:#21223C;"></span></p>
                                            </div>
