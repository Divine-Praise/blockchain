            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 d-flex flex-column mb-3">
                        <h2><b>{$settings.site_name}</b> Privacy Policy</h2>
                    </div>
                    <div class="col-lg-10 d-flex flex-column">

                        <p>This Privacy Policy of {$settings.site_name} Inc. (“{$settings.site_name},” “us,” “we,” and “our”) describes the information we collect about you when you access our website, enter into agreements with us, use our services and products, send us communications, or otherwise engage with us, and what we do with such information. Any references to {$settings.site_name} in this Privacy Policy also refers to its wholly owned subsidiaries. This Privacy Policy covers all of our services and products and all methods by which you may access our website.
                        </p>
                        ...
                        <p>{$settings.site_name} uses cookies in order to provide better service, to facilitate our customers’ use of our website, to track usage of the website, to collect data and to address certain security issues. When you access our website, we send the cookies to your computer or phone. Your computer or phone stores the cookie in a file located inside your web browser. The cookies help {$settings.site_name} keep track of your visits to our website and your activity on our website and to understand how you interact with us.</p>
                        ...
                        <p>{$settings.site_name} also uses Google Analytics. The following link explains how Google uses data when you use its partners’ websites and applications: www.google.com/policies/privacy/partners/. Your use of {$settings.site_name}’s website is evidence of your consent to {$settings.site_name} storing and accessing cookies and other information on your computer or phone and {$settings.site_name}’s use of Google Analytics in connection with such activities. Please read the information at the link provided so you understand what you are consenting to.</p>



                        <h6>Security</h6>
                        <p>{$settings.site_name} strives to ensure that our systems are secure and that they meet industry standards. We seek to protect non-public personal information that is provided to {$settings.site_name} by third-parties and by you by implementing physical and electronic safeguards. Where we believe appropriate, we employ firewalls, intrusion prevention, encryption technology, user authentication systems (i.e. passwords) and access control mechanisms to control access to systems and data. {$settings.site_name} endeavors to engage third-party service providers that have security and confidentiality policies, if such third-party service providers have access to our customer’s PII. We instruct our employees to use strict standards of care in handling the personal financial information of customers. As a general policy our staff will not discuss or disclose information regarding an account except with authorized personnel of our service providers or as required by applicable law and regulatory requirements law or pursuant to regulatory request and/or authority.</p>
                        ...
                        <p>Such records are generally retained as required by law, rule or regulation or for the minimum amount of time necessary to accomplish the purpose for which it was collected, and thereafter no longer than is permitted under {$settings.site_name}’s data retention policies.</p>
