                        ...
                        <div class="inside d-flex flex-column">
                            ...
                            <form method=post name=forgotform onsubmit="return checkform();">
                                ...
                                <div class="table-row d-flex align-items-center">
                                    <input type=text name='email' value="{$frm.email|escape:htmlall}" autofocus="autofocus" placeholder="Type your username or e-mail" autocomplete="off" autocorrect="off" autocapitalize="off" required=""> <i class="far fa-envelope float2"></i>
                                </div>
