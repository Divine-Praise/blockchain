                ...
                <div class="row all-center all-center flex-column">
                    <a href="/" class="mb-1">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 466.6 136" height="52">
                                                <svg version="1.1" id="Template Rex" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 124 36" enable-background="new 0 0 124 36" xml:space="preserve">
<g>
	<g>
			...
			<path fill="#353448" d="M121.5,18.8l-2.9-1.6l2.3-2.4l0.6,0.3V18.8z M119,17.1l2.2,1.2v-3.1l-0.3-0.1L119,17.1z"/>
                    ...
                    <div class="col-11 col-md-8 col-lg-5 form-box mb-3">
                        <div class="inside d-flex flex-column">
                            <h2 class="text-center center-bottom-line">Two Factor Authorization</h2>
                            ...
                            <form method=post name=mainform onsubmit="return checkform()">
                                ...
                                <div class="table-row d-flex align-items-center">
                                    <input type=text name=code value="" placeholder="Enter your Code 2FA" autocomplete="off" autocorrect="off" autocapitalize="off" required="">
