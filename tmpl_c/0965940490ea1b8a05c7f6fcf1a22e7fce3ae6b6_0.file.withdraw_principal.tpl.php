<?php /* Smarty version 3.1.27, created on 2023-10-04 07:48:02
         compiled from "/home/assetpin/public_html/tmpl/withdraw_principal.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:2116814631651d18b2154b63_50150881%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0965940490ea1b8a05c7f6fcf1a22e7fce3ae6b6' => 
    array (
      0 => '/home/assetpin/public_html/tmpl/withdraw_principal.tpl',
      1 => 1696380923,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2116814631651d18b2154b63_50150881',
  'variables' => 
  array (
    'settings' => 0,
    'fatal' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_651d18b2185d59_66064974',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_651d18b2185d59_66064974')) {
function content_651d18b2185d59_66064974 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '2116814631651d18b2154b63_50150881';
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="navbar-brand d-flex align-items-center">
                    ...
                    <a href="/" class="d-flex">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 466.6 136" height="28">
			...
			L87.8,18.8z" />
                ...
                <div class="collapse navbar-collapse accountMenu" id="MainNav">
                    ...
                    <ul class="navbar-nav navbar-nav--right ml-auto d-flex flex-nowrap shadow-left">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  text-center" href="?a=logout"><i class="icon icon-vm-1-3 rotate"></i></a>
                        </li>
                    </ul>
                    ...
                    <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                        <div class="wbox">
                            ...
                            <div class="depboxHome flex-fill d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center title p-3">
                                    <h6 class="m-0 mr-3">Release Contract</h6>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['fatal']->value == 'deposit_not_found') {?>
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        ...
                                        <h6 class="m-0">Transaction status</h6>
                                    </div>
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1">Wrong deposit ID has been provided </p>
                                    </div>
                                </div>
                                <?php }?>

                                <?php if ($_smarty_tpl->tpl_vars['fatal']->value == 'withdraw_forbidden') {?>
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        <i class="fas fa-times-circle mb-3 mt-2"></i>
                                        <h6 class="m-0">Transaction status</h6>
                                    ...
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1">Can not process principal withdrawal for this plan </p>
                                    </div>
                                </div>
                                <?php }?>

                                <?php if ($_smarty_tpl->tpl_vars['fatal']->value == 'too_early_withdraw') {?>
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        <i class="fas fa-times-circle mb-3 mt-2"></i>
                                        <h6 class="m-0">Transaction status</h6>
                                    ...
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1"> Can not process principal withdrawal yet</p>
                                    </div>
                                </div>
                                <?php }?>

                                <?php if ($_smarty_tpl->tpl_vars['fatal']->value == 'too_late_withdraw') {?>
                                ...
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    ...
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1">Can not process principal withdrawal longer </p>
                                    </div>
                                </div>
                                <?php }?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['fatal']->value == 'withdraw_complete') {?>
                                <div class="d-flex all-center flex-column p-0 status-ok">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#F1FAF6;width:100%;">
                                        ...
                                        <h6 class="m-0">Transaction confirmed!</h6>
                                    </div>
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1"> Withdrawal has been sucessfully completed.</p>
                                    </div>
                                </div>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['say']->value == 'too_big_amount') {?>
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        <i class="fas fa-times-circle mb-3 mt-2"></i>
                                        <h6 class="m-0">Transaction status</h6>
                                    ...
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1">You have no such amount on this deposit.</p>
                                    </div>
                                </div><?php }?>
                                <?php if ($_smarty_tpl->tpl_vars['say']->value == 'too_small_amount') {?>
                                <div class="d-flex all-center flex-column p-0 status-error">
                                    <div class="d-flex all-center flex-column p-3 pt-4 pb-4 flex-fill mb-2" style="background:#fde7e9;width:100%;">
                                        <i class="fas fa-times-circle mb-3 mt-2"></i>
                                        <h6 class="m-0">Transaction status</h6>
                                    ...
                                    <div class="d-flex all-center flex-column p-3">
                                        <p class="mt-2 mb-1">
                                            Provided amount is too small.</p>
                                    </div>
                                </div>
                                <?php }?>
                                ...
                                <form method=post name=withdraw_form id="withdraw_confirm">
...
>
                                    ...
                                    <div class="p-3 d-flex flex-column justify-content-center flex-fill">
                                        <div class="row depResult mt-2">

                                            <div class="bor col-12">
                                                <div class="d-flex align-items-center mb-1">
                                                    <i class="fas fa-minus-square ico-title d-flex all-center mr-2"></i>
                                                    <p class="m-0">Contract details :</p>
                                                </div>
                                                <div class="resultNum d-flex align-items-center p-2">
                                                    <p>Withdrawal from:</p>
...
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['deposit']->value['deposit']);?>
 deposit from the <b><?php echo smarty_modifier_myescape(htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['name'], ENT_QUOTES, 'UTF-8', true));?>
</b></p>
                                                </div>
                                                <div class="resultNum d-flex align-items-center p-2" style="border-radius:0 0 0 0;border-top:0px solid #fff;">
...
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['amount']->value);?>
                                                ...
                                                <div class="resultNum d-flex align-items-center p-2">
                                                    <p>Our fee is (<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['withdraw_principal_percent']);?>
%): </p>
                                                    <p>&nbsp;&nbsp;that is <b><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['fee']->value);?>
.</p>
                                                </div>
                                                <div class="resultNum d-flex align-items-center p-2">
                                                    <p>Actually you will acquire the total of : </p>
                                                    <p>&nbsp;&nbsp;<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
 ...
 on your balance.</p>
                                        ...
                                        <div class="p-3 d-flex flex-column justify-content-center">
                                            ...
                                            <div class="d-flex justify-content-between flex-wrap">
                                                <a class="d-flex align-items-center csa">

                                                    <span class="d-flex all-center"></span>
                                                </a>

                                                <a nohref="" onclick="document.getElementById('withdraw_confirm').submit();" class="d-flex align-items-center deposit-small-btn csa">
                                                    <span class="d-flex all-center">Confirm</span>
...
');
                                ...
                                function withdraw() {
                                    ...
                                    if (out_val < 0) {
                                        ...
                                        document.getElementById("quote").innerHTML = out_val.toFixed(currency_pow);
                                    }
                                } {
                                    /literal}
...
>
                                ...
                                <div class="p-3 d-flex flex-column justify-content-center flex-fill">
                                    ...
                                    <div class="depInput d-flex align-items-center m-1 mb-4" style="flex-flow:row wrap">
...
" id="inputsmoney" autocomplete="off" required="" style="min-width:100px;flex:1;border:0;margin:0;" onchange="withdraw()" onkeyup="withdraw()" onfocusout="withdraw()" onactivate="withdraw()" ondeactivate="withdraw()">
...
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['deposit']->value['deposit']);?>
 deposit from the <b><?php echo smarty_modifier_myescape(htmlspecialchars($_smarty_tpl->tpl_vars['type']->value['name'], ENT_QUOTES, 'UTF-8', true));?>
                                            ...
                                            <div class="resultNum d-flex align-items-center p-2" style="border-radius:0 0 0 0;border-top:0px solid #fff;">
                                                <p>Withdraw fee (<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['type']->value['withdraw_principal_percent']);?>
%) :</p>
                                                <p>&nbsp;&nbsp;<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);?>
0.01 as minimal</p>
                                            </div>
                                            <div class="resultNum d-flex align-items-center p-2">
                                                <p>You will get on you account balance : </p>
                                                <p>&nbsp;&nbsp;<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);?>
<span id="quote" name=quote readonly style="color:#21223C;"></span></p>
                                            </div>
                                ...
                                <div class="p-3 d-flex flex-column justify-content-center">
                                    ...
                                    <div class="d-flex justify-content-between flex-wrap">
                                        <a href="?a=deposit_list" class="d-flex align-items-center back-small-btn csa">
                                            <i class="fas fa-long-arrow-alt-left d-flex all-center"></i>
                                            <span class="d-flex all-center">Back</span>
                                        </a>
                                        <a nohref="" onclick="document.getElementById('withdraw_form').submit();" class="d-flex align-items-center deposit-small-btn csa">
