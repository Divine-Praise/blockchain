<?php /* Smarty version 3.1.27, created on 2023-10-05 15:08:58
         compiled from "/home/assetpin/public_html/tmpl/withdrawal.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:1149599672651ed18a211322_54255474%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '72e872ccea9a031c54c7df50dc01fa8719ffef3e' => 
    array (
      0 => '/home/assetpin/public_html/tmpl/withdrawal.tpl',
      1 => 1696380923,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1149599672651ed18a211322_54255474',
  'variables' => 
  array (
    'say' => 0,
    'batch' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_651ed18a269345_65760539',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_651ed18a269345_65760539')) {
function content_651ed18a269345_65760539 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '1149599672651ed18a211322_54255474';
...
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['fees']->value['amount_max']);?>
                ...
                <div id="alertwallet" class="container full-height " style="display: none;min-height: initial; padding-top: initial; padding-bottom: 20px;">
                    <div class="status-box errors col-xl-12" style="background:#FFEBCB;">
                        <p><i class="fas fa-bell"></i> Please set your <a href="?a=edit_account" style="font-size:.75rem;color:#374A5F;text-decoration:underline;font-weight:500;"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency']->value);?>
 Wallet address</a> to receive withdrawals!</p>
                    </div>
                </div>
                                        ...
                                        <div class="tab-pane fade active flex-fill show" id="navStep--1" role="tabpanel" aria-labelledby="navStep--1-tab">
                                            <div class="depboxHome flex-fill d-flex flex-column">
                                                ...
                                                <div class="p-4 d-flex flex-column justify-content-center flex-fill">
                                                    ...
                                                    <div class="txts">
                                                        <p>
                                                            - Payment System: <b style="font-size:.8rem;"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency']->value);?>
</b> <br>
                                                            - Wallet Address: <b id="walletid" style="font-size:.8rem;"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['account']->value);?>
</b> <br>
                                                            <?php if ($_smarty_tpl->tpl_vars['converted']->value) {?>
                                                            - Credit Amount: <b style="font-size:.8rem;"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['converted']->value['amount']);?>
</b> <br>

                                                            - <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['converted']->value['fiat']);?>
 Amount: <b style="font-size:.8rem;"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['to_withdraw']->value);?>
</b> <br>
...
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['to_withdraw']->value);?>
                                                            ...
                                                            <?php }?>
                                                            - Amount Withdraw: <b style="font-size:.8rem;"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['amount']->value);?>
</b> <br>
                                                            - Withdrawal Fee: <b style="font-size:.8rem;"><?php if ($_smarty_tpl->tpl_vars['fees']->value['fee'] > 0) {?>
...
>
                                                    ...
                                                    <div class="d-flex align-items-stretch pt-2 pb-2 flex-wrap TFA">
                                                        <p class="m-0 d-flex align-items-center"> <i class="fas fa-unlock-alt pr-2" style="color:#F8AC4A;background:none;box-shadow:none;height:auto;width:auto;"></i>
                                                            <span style="font-size:12px;"><img src="<?php echo smarty_modifier_myescape(encurl(" ?a=show_validation_image&".((string)$_smarty_tpl->tpl_vars['ti']->value['session']['name'])."=".((string)$_smarty_tpl->tpl_vars['ti']->value['session']['id'])."&rand=".((string)$_smarty_tpl->tpl_vars['ti']->value['session']['rand'])));?>
"></span>
                                                            <small style="color:#EBAE77;font-style:normal;">&nbsp;*</small>
                                                        </p>
                            ...
                            <div class="col-xl-4 p-0 depboxHome border-right">
                                ...
                                <path d="M243,0C108.8,0,0,108.8,0,243s108.8,243,243,243s243-108.8,243-243S377.2,0,243,0z M312.8,338.8 c-10.6,12.9-24.4,21.6-40.5,26c-7,1.9-10.2,5.6-9.8,12.9c0.3,7.2,0,14.3-0.1,21.5c0,6.4-3.3,9.8-9.6,10
									...
									C330.9,250.9,342.1,303.2,312.8,338.8z" fill="#F8AC4A" />
                                        ...
                                        <label class="m-0 ml-2 mr-1"><?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
                                            ...
                                            <div class="depboxHome flex-fill d-flex flex-column">
                                                ...
                                                <div class="p-4 d-flex flex-column justify-content-center flex-fill">
                                                    ...
                                                    <div class="depInput d-flex align-items-center mb-4" style="flex-flow:row wrap">
                                                        ...
                                                        <input type="number" name="amount" value="<?php echo smarty_modifier_myescape((($tmp = @amount_smarty_format($_smarty_tpl->tpl_vars['frm']->value['amount']))===null||$tmp==='' ? " 10.00" : $tmp));?>
" id="inputsmoney" autocomplete="off" required="" autocomplete="off" style="min-width:100px;flex:1;border:0;margin:0;">
                                                        <!-- <input type="number" name="amount" value="<?php echo smarty_modifier_myescape((($tmp = @amount_smarty_format($_smarty_tpl->tpl_vars['frm']->value['amount']))===null||$tmp==='' ? "10.00" : $tmp));?>
" id="inputsmoney" autocomplete="off" required="" autocomplete="off" required min="0.0005" step="0.00000001" style="min-width:100px;flex:1;border:0;margin:0;"> -->
...
if ($_smarty_tpl->tpl_vars['p']->value['status'] > 0 || $_smarty_tpl->tpl_vars['p']->value['available'] > 0) {?><input id="value-<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['p']->value['id']);?>
" type="radio" name="ec" value="<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['p']->value['id']);?>
" <?php if ($_smarty_tpl->tpl_vars['frm']->value['ec'] == $_smarty_tpl->tpl_vars['p']->value['id']) {?>checked<?php }?>><?php }
}?> <label for="value-<?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['p']->value['id']);?>
" class="d-flex flex-column selectoryx">
                                                                <b><span class="d-flex align-items-center"><?php echo smarty_modifier_myescape(htmlspecialchars($_smarty_tpl->tpl_vars['p']->value['name'], ENT_QUOTES, 'UTF-8', true));?>
</span></b>

                                                                <span class="d-flex align-items-center">Available: <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['p']->value['available']);?>
</span>
                                                                <b class="d-flex align-items-center"><span style="flex:1;">Pending: <?php echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['currency_sign']->value);
echo smarty_modifier_myescape($_smarty_tpl->tpl_vars['p']->value['pending']);?>
</span><i class="fas icon icon-todo"></i></b>
