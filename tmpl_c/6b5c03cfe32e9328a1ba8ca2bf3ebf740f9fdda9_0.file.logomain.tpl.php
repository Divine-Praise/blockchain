<?php /* Smarty version 3.1.27, created on 2023-10-10 03:01:50
         compiled from "/home/assetpin/public_html/tmpl/logomain.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:14168969916524be9e70f7e1_28741712%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b5c03cfe32e9328a1ba8ca2bf3ebf740f9fdda9' => 
    array (
      0 => '/home/assetpin/public_html/tmpl/logomain.tpl',
      1 => 1696501637,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14168969916524be9e70f7e1_28741712',
  'variables' => 
  array (
    'settings' => 0,
  ),
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_6524be9e712154_02554565',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_6524be9e712154_02554565')) {
function content_6524be9e712154_02554565 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '14168969916524be9e70f7e1_28741712';
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container-fluid">
			<div class="navbar-brand d-flex align-items-center">
				<a href="/" class="navbar-brand">
					                    ...
					                    <img src="styles/img/logo.png" alt="Template Rex" width="90px" >
			...
			<div class="collapse navbar-collapse accountMenu" id="MainNav">
				<ul class="navbar-nav mr-auto mt-sms-3">
					...
					<li class="nav-item">
                            <a class="nav-link  text-center" href="https://www.buybitcoinworldwide.com">Buy Bitcoin</a>
                        </li>
				</ul>
				...
				<ul class="navbar-nav navbar-nav--right ml-auto d-flex flex-nowrap shadow-left">
					...
					<?php }?>
					<li class="nav-item">
						<a class="nav-link  text-center" href="?a=logout"><i class="icon icon-vm-1-3 rotate"></i>Logout</a>
					</li>
				</ul>
